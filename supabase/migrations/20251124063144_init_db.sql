/*
  ...
  1. New Tables
    - `companies` - Store company information with sales assignments
    ...
    - `dealNotes` - Notes for deals
    - `sales` - User/sales rep information linked to auth.users
    - `tags` - Tags for categorizing contacts
    - `tasks` - Tasks assigned to contacts

  2. Security
    - Enable RLS on all tables
    - Add policies for authenticated users to read, insert, update, delete
    - Create storage bucket for attachments with appropriate policies

  3. Views
    - `companies_summary` - Companies with deal and contact counts
