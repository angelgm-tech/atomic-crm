/*
  # Remove acquisition column from contacts

  1. Changes
    - Drop `acquisition` column from `contacts` table
    - Recreate `contacts_summary` view without the acquisition field
*/

-- this will drop the `contacts_summary` view as well
ALTER TABLE  "public"."contacts"
DROP COLUMN IF EXISTS acquisition CASCADE;
